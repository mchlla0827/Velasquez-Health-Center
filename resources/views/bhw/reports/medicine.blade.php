...
<head>
    ...
    <meta charset="UTF-8">
    <title>BHW Portal - Inventory Report</title>
    ...
    <style>
        ...
        .badge { padding: 4px 10px; border-radius: 8px; font-size: 12px; border: 1px solid #E5E7EB; }
        .badge.low { background: #FEF2F2; color: #991B1B; }
        .badge.ok { background: #F9FAFB; color: #374151; }
    ...
    <div class="main">
        ...
        <div class="content-card">
            <div class="summary-grid">
                ...
                <div class="summary-box">
                    <span>Total Unit Stock</span>
                    <h3>{{ $totalStockCount ?? '0' }}</h3>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $med->stock }}</td>
                            <td>
                                <span class="badge {{ $med->stock <= 10 ? 'low' : 'ok' }}">
                                    {{ $med->stock <= 10 ? 'Restock Needed' : 'In Stock' }}
                                </span>
                            </td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" style="text-align:center; padding: 20px; color: #6B7280;">No inventory data available for current selection.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>

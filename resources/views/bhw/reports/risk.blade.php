...
<head>
    ...
    <meta charset="UTF-8">
    <title>BHW Portal - Risk Reports</title>
    ...
    <style>
        ...
        .summary-box span { font-size: 12px; color: #6B7280; display: block; margin-bottom: 6px; }
        .summary-box h3 { font-size: 20px; font-weight: 700; margin: 0; }
        ...
        thead th { background: #F9FAFB; font-weight: 600; text-align: left; padding: 14px 12px; border-bottom: 1px solid #E5E7EB; font-size: 13px; color: #374151; }
        ...
        .risk-badge.high { border-color: #D1D5DB; font-weight: 600; color: #B91C1C; }
        .risk-badge.moderate { opacity: 0.85; color: #92400E; }
        .risk-badge.low { opacity: 0.7; color: #15803D; }
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="page-title">Patient Risk-Scoring Summary</div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $risk->score }}</td>
                            <td>
                                @if($risk->risk_level == 'High') Alert Nurse Immediately
                                @elseif($risk->risk_level == 'Moderate') Queue for Priority
                                @else Standard Queue @endif
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" style="text-align:center; padding: 20px; color: #6B7280;">No screened risk records found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>

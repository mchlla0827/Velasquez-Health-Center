...
<head>
    ...
    <meta charset="UTF-8">
    <title>BHW Portal - Patient Reports</title>
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="page-title">Patient Records Reports</div>
        ...
        <div class="content-card">
            <div class="summary-grid">
                ...
                <div class="summary-box">
                    <span>Returning for Check-up</span>
                    <h3 id="returningPatients">--</h3>
                </div>
                <div class="summary-box">
                    <span>Common Barangay</span>
                    <h3 id="commonBrgy">--</h3>
                </div>
            </div>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody id="patientTable">
                        <tr>
                            <td colspan="6" style="text-align:center; padding: 20px; color: #6B7280;">No data loaded. Select parameters and click 'Generate'.</td>
                        </tr>
                    </tbody>
                </table>
            </div>

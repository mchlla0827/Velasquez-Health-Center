...
<head>
    ...
    <meta charset="UTF-8">
    <title>BHW Portal - Dispensing Report</title>
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="page-title">Dispensing History Report</div>
        ...
        <div class="content-card">
            <div class="summary-grid">
                <div class="summary-box">
                    <span>Total Units Given</span>
                    <h3>{{ $totalDispensed ?? '0' }}</h3>
                </div>
                <div class="summary-box">
                    <span>Dispensed Today</span>
                    <h3>{{ $todayDispensed ?? '0' }}</h3>
                </div>
                <div class="summary-box">
                    <span>Top Medicine Issued</span>
                    <h3>{{ $mostDispensed ?? '--' }}</h3>
                </div>
                <div class="summary-box">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        @forelse($dispensing ?? [] as $d)
                        <tr>
                            <td>{{ $d->patient_name }}</td>
                            <td>{{ $d->medicine_name }}</td>
                            <td>{{ $d->quantity }}</td>
                            <td>{{ $d->date_dispensed }}</td>
                            <td>{{ $d->staff_name ?? 'Center Staff' }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" style="text-align:center; padding: 20px; color: #6B7280;">No distribution logs available for the selected period.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
